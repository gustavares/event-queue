...
- [Project Overview](project_overview.md) — Event Queue: guest list/door management platform for Brazilian nightlife venues
- [Agent System](project_agent_system.md) — Three-skill agent system (/po, /architect, /designer) approved and designed
